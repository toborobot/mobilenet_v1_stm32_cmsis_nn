...
original github repo is by Alessandro Capotondi and Manuele Rusci is [here](https://github.com/EEESlab/mobilenet_v1_stm32_cmsis_nn)
...
+ Add the URI (original repo) `https://github.com/EEESlab/mobilenet_v1_stm32_cmsis_nn.git` and click `Next`
